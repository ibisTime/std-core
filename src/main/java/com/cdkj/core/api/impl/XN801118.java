...
import com.cdkj.core.dto.req.XN801118Req;
...
public class XN801118 extends AProcessor {
    ...
    public Object doBusiness() throws BizException {
        ...
        return couponAO.queryMyCouponPage(start, limit, condition);
    }

    @Override
    public void doCheck(String inputparams) throws ParaException {
        req = JsonUtil.json2Bean(inputparams, XN801118Req.class);
        StringValidater.validateBlank(req.getToUser(), req.getCompanyCode(),
            req.getSystemCode());
