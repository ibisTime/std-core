...
import com.cdkj.core.dto.req.XN801917Req;
 ...
 * @history:
 */
public class XN801917 extends AProcessor {
    private ISYSConfigAO sysConfigAO = SpringContextHolder
        .getBean(ISYSConfigAO.class);

    private XN801917Req req = null;
    ...
    public void doCheck(String inputparams) throws ParaException {
        req = JsonUtil.json2Bean(inputparams, XN801917Req.class);
