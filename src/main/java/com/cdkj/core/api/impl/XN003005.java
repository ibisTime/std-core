...
import com.cdkj.core.dto.req.XN003005Req;
 ...
 * @history:
 */
public class XN003005 extends AProcessor {
    private ICommentAO commentAO = SpringContextHolder
        .getBean(ICommentAO.class);

    private XN003005Req req = null;
    ...
    public Object doBusiness() throws BizException {
        ...
        return commentAO.queryBizCommentPage(start, limit, condition);
    }

    @Override
    public void doCheck(String inputparams) throws ParaException {
        req = JsonUtil.json2Bean(inputparams, XN003005Req.class);
        StringValidater
