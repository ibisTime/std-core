...
public class KeywordBOImpl extends PaginableBOImpl<Keyword> implements
    ...
    /** 
     * @see com.std.activity.bo.IKeywordBO#saveKeyword(com.std.activity.domain.Keyword)
     */
    @Override
    ...
    /** 
     * @see com.std.activity.bo.IKeywordBO#refreshKeyword(com.std.activity.domain.Keyword)
     */
    @Override
    ...
    /** 
     * @see com.std.activity.bo.IKeywordBO#getKeyword(java.lang.String)
     */
    @Override
    ...
    /** 
     * @see com.std.activity.bo.IKeywordBO#queryKeywordList(com.std.activity.domain.Keyword)
     */
    @Override
    ...
    /** 
     * @see com.std.activity.bo.IKeywordBO#removeKeyword(java.lang.String)
     */
    @Override
