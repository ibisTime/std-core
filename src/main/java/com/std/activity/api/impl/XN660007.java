...
import com.std.activity.dto.req.XN660007Req;
...
public class XN660007 extends AProcessor {
    ...
    public void doCheck(String inputparams) throws ParaException {
        req = JsonUtil.json2Bean(inputparams, XN660007Req.class);
