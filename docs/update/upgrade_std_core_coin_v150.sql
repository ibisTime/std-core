...
UPDATE `tstd_country` SET `pic`='Indonesia.png' WHERE `inter_code`='0062';
UPDATE `tstd_country` SET `pic`='Malaysia.png' WHERE `inter_code`='0060';
UPDATE `tstd_country` SET `pic`='China.png' WHERE `inter_code`='0086';
UPDATE `tstd_country` SET `pic`='SouthKorea.png' WHERE `inter_code`='0082';
